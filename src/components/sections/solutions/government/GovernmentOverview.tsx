      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Transforming <span className="gradient-text">Government Services</span> in Rwanda
          </h2>
        ...
        >
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Rwanda's <span className="gradient-text">Digital Government</span> Vision
            </h3>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose <span className="gradient-text">CyLaCon</span> for Government IT?
            </h3>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">Government <span className="text-primary-200">Technology Standards</span></h3>
