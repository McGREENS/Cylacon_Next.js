      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Comprehensive <span className="gradient-text">Healthcare IT Solutions</span>
          </h2>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">
              Specialized <span className="gradient-text">Healthcare Solutions</span>
            </h3>
        ...
        >
          <Heart className="w-16 h-16 mx-auto mb-6 text-secondary-200" />
          <h3 className="text-3xl font-bold mb-4">Supporting Rwanda's <span className="text-secondary-200">Health Sector</span></h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-secondary-200">Healthcare Facilities</div>
              <div className="text-sm text-secondary-100">Successfully digitized</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold mb-2">100K+</div>
              <div className="text-secondary-200">Patient Records</div>
              <div className="text-sm text-secondary-100">Securely managed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold mb-2">24/7</div>
              <div className="text-secondary-200">System Support</div>
              <div className="text-sm text-secondary-100">Continuous healthcare IT support</div>
            </div>
          </div>
        </motion.div>
      </div>
