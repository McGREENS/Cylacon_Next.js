  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">
              Specialized <span className="gradient-text">Education Solutions</span>
            </h3>
        ...
        >
          <GraduationCap className="w-16 h-16 mx-auto mb-6 text-secondary-200" />
          <h3 className="text-3xl font-bold mb-4">Supporting Rwanda's <span className="text-secondary-200">Education Excellence</span></h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-secondary-200">Schools Digitized</div>
              <div className="text-sm text-secondary-100">Educational institutions served</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold mb-2">50K+</div>
              <div className="text-secondary-200">Students Impacted</div>
              <div className="text-sm text-secondary-100">Through digital learning platforms</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold mb-2">24/7</div>
              <div className="text-secondary-200">Learning Access</div>
              <div className="text-sm text-secondary-100">Round-the-clock educational resources</div>
            </div>
          </div>
        </motion.div>
      </div>
